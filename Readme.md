...
<!--progress-->
<p align="center">
  <img src="docs/assets/progress.cc99125f.svg" width="100%" alt="Ferrum progress — 96% toward playable gameplay, 99% of the substrate, 2593 checks passing">
</p>
...
<td width="58%"><a href="docs/progress.md#cutscene-video"><img src="docs/assets/bars/video.414a0372.svg" width="320" height="14" alt="100 percent"></a></td>
<td width="12%" align="right"><b>100%</b></td>
</tr>
<tr>
...
<sub>Every row links to <a href="docs/progress.md">what earned that number</a> — in plain English, no code. Orange is the critical path to a game running. <b>2593 automated checks</b> pass; each one fails if its capability is removed.</sub><!--/progress-->
