...
<!--progress-->
<p align="center">
  <img src="docs/assets/progress.8b5ffffa.svg" width="100%" alt="Ferrum progress — 68% toward playable gameplay, 79% of the substrate, 468 checks passing">
</p>
...
<sub>Every row links to <a href="docs/progress.md">what earned that number</a> — in plain English, no code. Orange is the critical path to a game running. <b>468 automated checks</b> pass; each one fails if its capability is removed.</sub><!--/progress-->
