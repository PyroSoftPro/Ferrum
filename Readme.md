...
<!--progress-->
<p align="center">
  <img src="docs/assets/progress.daeedd73.svg" width="100%" alt="Ferrum progress — 70% toward playable gameplay, 79% of the substrate, 487 checks passing">
</p>
...
<td width="58%"><a href="docs/progress.md#game-windows-and-input"><img src="docs/assets/bars/windows.24ecf896.svg" width="320" height="14" alt="90 percent"></a></td>
...
<td width="58%"><a href="docs/progress.md#speed"><img src="docs/assets/bars/speed.3b86a206.svg" width="320" height="14" alt="82 percent"></a></td>
<td width="12%" align="right"><b>82%</b></td>
</tr>
<tr>
<td width="30%"><a href="docs/progress.md#directx-11">DirectX 11</a></td>
<td width="58%"><a href="docs/progress.md#directx-11"><img src="docs/assets/bars/d3d.e6ec9ada.svg" width="320" height="14" alt="75 percent"></a></td>
...
<td width="58%"><a href="docs/progress.md#2-d-drawing-for-menus-and-huds"><img src="docs/assets/bars/gdi.20dd69da.svg" width="320" height="14" alt="64 percent"></a></td>
<td width="12%" align="right"><b>64%</b></td>
</tr>
<tr>
<td width="30%"><a href="docs/progress.md#sound">Sound</a></td>
<td width="58%"><a href="docs/progress.md#sound"><img src="docs/assets/bars/sound.88440534.svg" width="320" height="14" alt="55 percent"></a></td>
<td width="12%" align="right"><b>55%</b></td>
</tr>
<tr>
<td width="30%"><a href="docs/progress.md#installers-and-saves">Installers and saves</a></td>
<td width="58%"><a href="docs/progress.md#installers-and-saves"><img src="docs/assets/bars/installers.98137349.svg" width="320" height="14" alt="38 percent"></a></td>
<td width="12%" align="right"><b>38%</b></td>
</tr>
</table>

<sub>Every row links to <a href="docs/progress.md">what earned that number</a> — in plain English, no code. Orange is the critical path to a game running. <b>487 automated checks</b> pass; each one fails if its capability is removed.</sub><!--/progress-->
